 ...
 */
export function parseRoute(url: URL, basePath: string, tables: IntrospectedTable[]): ParsedRoute | null {
 ...
 */
export function resolveAction(route: ParsedRoute, method: string): CrudAction | 'dashboard' | null {
 ...
 */
export function cmsUrl(basePath: string, tableName?: string, recordId?: string, action?: string): string {
